...
def silver_videoCategory_cleaned(context: AssetExecutionContext,
    ...
    with create_spark_session(CONFIG, "silver_videoCategory_cleaned-{}".format(datetime.today())) as spark:
...
def silver_linkVideos_cleaned(context: AssetExecutionContext,
    ...
    # with create_spark_session(CONFIG, "silver_linkVideos_cleaned-{}".format(datetime.today())) as spark:
